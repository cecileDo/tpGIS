...
class Image:
    ...
    def draw_rectangle(self, x0, y0, width, height, stroke, fill):
        """
        ...
        """
        self.ctx.set_source_rgba(*fill)
        self.ctx.rectangle(x0, y0, width, height)
        self.ctx.fill()
        self.ctx.set_source_rgba(*stroke)
        self.ctx.rectangle(x0, y0, width, height)
        self.ctx.stroke()

    def draw_text(self,text, x0, y0, color, size):
        """
        Dessine un point.
        ...
        #self.ctx.set_font_face("Purisa")
        self.ctx.set_font_size(size)
        #self.ctx.text_extents()
